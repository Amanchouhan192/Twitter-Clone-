...
public class userController extends BaseController {
    ...
    public String followed(ModelMap modelMap, HttpServletResponse response, HttpServletRequest request) {
        ...
        Condition selectMemberConditions = tech.codingclub.helix.tables.Member.MEMBER.ID.in(followedIds);
        List<Member> followedMembers = (List<Member>) GenericDB.getRows(tech.codingclub.helix.tables.Member.MEMBER,Member.class,selectMemberConditions,10,tech.codingclub.helix.tables.Member.MEMBER.ID.desc());
        // access only when he is login!
